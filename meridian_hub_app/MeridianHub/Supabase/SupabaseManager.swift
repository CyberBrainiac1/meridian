...
/// from the app's Info.plist / build settings, which XcodeGen populates from
/// Config/Secrets.xcconfig. That file is gitignored — a clone has to supply
/// its own before the app can reach anything.
enum SupabaseConfig {
    static var url: URL {
        guard
