...
/// language. See FamRadius/FamSpacing below for the concrete
/// deltas from Care.
enum FamColor {
...
// `Color(hex:alpha:)` used to be declared here as well. Care's copy in
// Care/DesignSystem/Tokens.swift is byte-identical and now that all three
// interfaces are one module, two of them would be a redeclaration. Care's
// serves this file too.
