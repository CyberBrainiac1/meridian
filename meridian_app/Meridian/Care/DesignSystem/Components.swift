...
struct CareCardBackground: ViewModifier {
...
struct CareAlertArrival: ViewModifier {
    let trigger: Bool
...
extension View {
    func careAlertArrival(_ trigger: Bool) -> some View {
        modifier(CareAlertArrival(trigger: trigger))
    }
}
