...
enum CareMedicationDoseStatus: String, Codable {
...
struct MedicationDose: Codable, Identifiable, Equatable {
    ...
    let status: CareMedicationDoseStatus
...
enum CareActivityType: String, Codable {
...
enum CareActivityCompletionStatus: String, Codable {
...
struct ActivitySlot: Codable, Identifiable, Equatable {
    ...
    let label: String
    let scheduledFor: Date
    let status: CareActivityCompletionStatus
