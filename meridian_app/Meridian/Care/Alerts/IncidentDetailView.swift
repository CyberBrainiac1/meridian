...
struct IncidentDetailView: View {
    ...
    private func actionLabel(_ status: CareIncidentStatus) -> String {
        switch status {
    ...
    private func buttonKind(_ status: CareIncidentStatus) -> MeridianButtonStyle.Kind {
        switch status {
    ...
    private func respond(_ status: CareIncidentStatus) async {
        isSubmitting = true
        errorMessage = nil
