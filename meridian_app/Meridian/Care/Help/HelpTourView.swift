...
struct CareHelpToolbarButton: View {
    let topic: CareHelpTopic
...
struct CareHelpTourView: View {
    let topic: CareHelpTopic

    @Environment(\.dismiss) private var dismiss
    @State private var stepIndex = 0

    private var steps: [CareHelpStep] { topic.steps }
