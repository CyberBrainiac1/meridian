...
final class ResidentDetailViewModel: ObservableObject {
    ...
    func record(_ dose: MedicationDose, as status: CareMedicationDoseStatus) async {
    ...
    /// database rather than being optimistically assumed here.
    func record(_ slot: ActivitySlot, as status: CareActivityCompletionStatus) async {
